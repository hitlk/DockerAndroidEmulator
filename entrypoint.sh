...
echo "no" | /usr/local/android-sdk/emulator/emulator -avd test -skin 1080x1920 -cores 4 -memory 3000 -partition-size 8192 -netfast -netspeed full -netdelay none -noaudio -no-window -verbose -qemu -usbdevice tablet -vnc :0
